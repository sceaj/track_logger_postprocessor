...
class Test(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_state.set_data_item('Throttle', 255)
        self.test_state.set_data_item('ECU_Throttle', 255)
        self.test_state.set_data_item('Brake', 0)
        self.test_state.set_data_item('Brake_Pressure', 0.0)
    ...
    def testFormatLine(self):
        ...
        self.assertEqual("321.36, 21:23:48.021, 15-05-19, 39.7392, 104.9903, 1609, 0.15, 0.86, 1.18, 86.30, 3, 5891, 3, 255, 255, 0, 0.00, 0, 6.21, 0.42, 99, 240, 96, 85.20, 86.90, 85.00, 86.70, 0, 0.86, 321.41, 0.10, , , ",
                test_csv_line,
                "The generated CSV line doesn't match the expected value.")
        pass
